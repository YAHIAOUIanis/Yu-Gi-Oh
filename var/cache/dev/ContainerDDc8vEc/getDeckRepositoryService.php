...
// Returns the private 'App\Repository\DeckRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\DeckRepository.php';

return $this->privates['App\Repository\DeckRepository'] = new \App\Repository\DeckRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
