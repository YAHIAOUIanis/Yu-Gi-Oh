...
// Returns the private 'App\Repository\CardsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CardsRepository.php';

return $this->privates['App\Repository\CardsRepository'] = new \App\Repository\CardsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
